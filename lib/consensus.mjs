...
const ENGINES = [
  ...
  // set OVERSEER_OLLAMA_MODEL to any model you've pulled (`ollama list`); defaults to llama3.1
  { id: 'ollama',  bin: 'ollama', args: (p) => ['run', process.env.OVERSEER_OLLAMA_MODEL || 'llama3.1', p], timeout: 420000 },
];
